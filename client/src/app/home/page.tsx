    ...
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
      ...
      <div className="rounded-lg bg-white p-4 shadow dark:bg-dark-secondary md:col-span-2">
        ...
        <div style={{ height: 400, width: "100%"}}>
          <DataGrid rows={tasks} columns={taskColumns} checkboxSelection loading={tasksLoading} getRowClassName={() => "data-grid-row"} getCellClassName={() => "data-grid-cell"} className={dataGridClassNames} sx={dataGridSxStyles(isDarkMode)} />
        </div>
        </div>
    </div>
  </div>;
