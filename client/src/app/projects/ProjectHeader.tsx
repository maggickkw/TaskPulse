...
import ModalNewProject from "./ModalNewProjects";
    ...
    <div className="px-4 xl:px-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          <input type="text" placeholder="Search Task" className=" rounded-md border py-1 pl-10 pr-4 focus:outline-none dark:bg-dark-secondary dark:text-white" />
