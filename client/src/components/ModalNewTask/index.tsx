...
const formattedDueDate = formatISO(new Date(dueDate), { representation: 'complete'})
  ...
  const inputStyles =
    "w-full rounded border-gray-300 p-2 shadow-sm dark:border-dark-tertiary dark:bg-dark-tertiary dark:text-white dark:focus:outline-none resize-none";
